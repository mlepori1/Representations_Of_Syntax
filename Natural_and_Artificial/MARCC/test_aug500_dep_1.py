...
model = models.TreeLSTMClassifier(100, 100, len(word2idx.keys()), 'dependency', pretrained_embeddings=embed_matrix)
model.load_state_dict(torch.load('./augmented_models/aug_dep_1_500_model'))
