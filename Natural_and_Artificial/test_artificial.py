...
if __name__ == "__main__":
    ...
    train_set, test_set = make_set('./corpora/agreement_corpus.txt', 300, 100, True, dep_gram)


    ############################## Load Up the appropriate Model
    ...
    model.load_state_dict(torch.load('./data/hybrid_model_3'))


    ############################ Test on Test Set
    print(f'Artificial Test Set Length: {len(test_set)}')
    correct = 0
